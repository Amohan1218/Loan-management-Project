...
<body>
    ...
    <script>
    	...
    	function checkEle(){
    		const a = document.getElementById("DisIcm").value; 
    		const b = document.getElementById("emiAmt").value;
    		console.log(a+"--"+b);
    		if(a > b){
    			document.getElementById("eligibility").value = "";
    			document.getElementById("eligibility").value = "High Chance of Approval";
    		}
    		if(a < b){
    			document.getElementById("eligibility").value = "";
    			document.getElementById("eligibility").value = "Low Chance of Approval";
    		}
    		if(a == "" || b == ""){
    			document.getElementById("eligibility").value = "";
    			document.getElementById("eligibility").value = "Enter Valid Input!!!";
    		}
    	}
