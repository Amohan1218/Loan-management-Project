<%@page import="com.folder.orm.model.LoanApplicant"%>
<%@page import="java.util.List, com.folder.orm.model.*"%>
			    ...
			    <div class="col-md-6">
			        <div class="card mb-4">
			            <div class="card-body">
			                ...
			                <p class="card-text">Customer Name: <%= obj.getCustomer().getFirstName() %></p>
